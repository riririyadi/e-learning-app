      ...
      >
        <div className="classroom-detail p-4 text-white d-flex align-items-start flex-column">
          ...
          <div className="mt-auto">
            ...
            <span data-tooltip-text="James" style={{zIndex:0}}>
              <img
            ...
            <span data-tooltip-text="Nina" style={{zIndex:1, marginLeft:"-8px"}}>
              <img
            ...
            <span data-tooltip-text="Danny" style={{zIndex:2, marginLeft:"-8px"}}>
              <img
             ...
             <span data-tooltip-text="Audrey" style={{zIndex:2, marginLeft:"-8px"}}>
              <img
              ...
              />
            </span> <span data-tooltip-text="Rae" style={{zIndex:2, marginLeft:"-8px"}}>
              <img
            ...
            <span className="ml-2" style={{fontSize:'12px', color:"lightgray"}}><i>...+29 more</i></span>
          </div>
        </div>
      </div>
       <div className="mt-4 mb-4 d-flex bd-highlight">
          ...
          <div className="ml-4 bd-highlight" style={{ fontSize: "15px" }}>
            <span data-tooltip-text-1="Create New Lesson">
            <Link to="/u/classroom/manage/create-new-lesson">
          ...
          >
            ...
            >
              <div className="mb-2 d-flex">
               ...
               <div> Lesson {i + 1} - {data.lessonName}</div><div className="ml-auto">
                <RiSettingsLine /> Edit
               </div>
              </div>
              <div className="mb-2">
