...
export default function StudentClassroom() {
  ...
  const classroomData = [
    { subject: "PPSI", class: "4KA21", teacher: "Casey Dubravka" },
    {
      subject: "Manajemen Sistem Informasi",
      class: "4KA21",
      teacher: "Ibrahim Affelay",
    },
    { subject: "Sistem Multimedia", class: "4KA21", teacher: "Abdullah Abbas Defaye" },
    {
    ...
    { subject: "Programming", class: "4KA21", teacher: "Cassidy Love" },
  ];
    ...
    <div>
      <div className="mt-4 mb-4 d-flex bd-highlight">
        ...
        <div className="ml-4 bd-highlight" style={{ fontSize: "15px" }}>
          <span data-tooltip-text="Join New Class" onClick={handleOpenModal}>
            ...
            >
              ...
              >
                ...
                <div className="mt-auto d-flex" style={{ width: "100%" }}>
                  <div>
                    <Link to="/u/classroom/detail" className="dark-link">
                      <IoIosLogIn/>
                      <span className="ml-2">Enter</span>
                    </Link>
                  </div>
                  <div className="ml-auto">
                    <span data-tooltip-text={`Teacher: ${data.teacher}`}>
                      <img
